    ...
    return(
        <div className='container-box md:w-1/2'>
            <div className={`${props.daily ?"bg-daily" : "bg-focus"} bg-opacity-50 flex flex-col items-start h-full`}>
                ...
                <div className={'flex flex-col gap-2 px-2 my-3 w-full scrollbar-config'}>
                    {props.content.length === 0 ? <p className='text-zinc-100 text-center w-full py-2'>No character/weapon to focus!</p> : null}
